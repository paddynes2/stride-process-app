...
export async function POST(request: NextRequest) {
  ...
  // Fetch section — RLS ensures caller can access it
  ...
  // Validate section belongs to the specified workspace
  if (section.workspace_id !== workspace_id) {
    return errorResponse("validation", "Section does not belong to the specified workspace", 400);
  }
